...
MODULE="02-sql/learning-materials"
...
echo "Filling SQL learning materials..."

write_file_safe "$MODULE/README.md" <<'EOF'
...
write_file_safe "$MODULE/query_pattern_cheatsheet.md" <<'EOF'
...
write_file_safe "$MODULE/data_modeling_comparison.md" <<'EOF'
...
write_file_safe "$MODULE/indexing_strategy_across_databases.md" <<'EOF'
...
write_file_safe "$MODULE/01_sql_analytics_patterns/README.md" <<'EOF'
...
write_file_safe "$MODULE/01_sql_analytics_patterns/top_n.md" <<'EOF'
# Top N Pattern
...
write_file_safe "$MODULE/01_sql_analytics_patterns/deduplication.md" <<'EOF'
...
write_file_safe "$MODULE/01_sql_analytics_patterns/sessionization.md" <<'EOF'
...
write_file_safe "$MODULE/01_sql_analytics_patterns/funnel_analysis.md" <<'EOF'
...
write_file_safe "$MODULE/01_sql_analytics_patterns/retention_analysis.md" <<'EOF'
...
write_file_safe "$MODULE/01_sql_analytics_patterns/running_totals.md" <<'EOF'
...
write_file_safe "$MODULE/01_sql_analytics_patterns/cohort_analysis.md" <<'EOF'
...
write_file_safe "$MODULE/01_sql_analytics_patterns/scd_type2.md" <<'EOF'
# SCD Type 2 Pattern
...
write_file_safe "$MODULE/01_sql_analytics_patterns/practice_queries.md" <<'EOF'
# Practice Queries
...
write_file_safe "$MODULE/02_sql_for_lakehouse/README.md" <<'EOF'
...
write_file_safe "$MODULE/02_sql_for_lakehouse/delta_tables.md" <<'EOF'
# Delta Tables
...
write_file_safe "$MODULE/02_sql_for_lakehouse/merge_operations.md" <<'EOF'
# Merge Operations
...
write_file_safe "$MODULE/02_sql_for_lakehouse/partitioning.md" <<'EOF'
# Partitioning
...
write_file_safe "$MODULE/02_sql_for_lakehouse/time_travel.md" <<'EOF'
# Time Travel
...
write_file_safe "$MODULE/02_sql_for_lakehouse/schema_evolution.md" <<'EOF'
# Schema Evolution
...
write_file_safe "$MODULE/02_sql_for_lakehouse/optimization_patterns.md" <<'EOF'
...
write_file_safe "$MODULE/02_sql_for_lakehouse/practice_queries.md" <<'EOF'
# Practice Queries
...
write_file_safe "$MODULE/03_sql_vs_nosql_architecture/README.md" <<'EOF'
...
write_file_safe "$MODULE/03_sql_vs_nosql_architecture/architecture.md" <<'EOF'
# Architecture
...
write_file_safe "$MODULE/03_sql_vs_nosql_architecture/consistency_and_scaling.md" <<'EOF'
...
write_file_safe "$MODULE/03_sql_vs_nosql_architecture/modeling_differences.md" <<'EOF'
...
write_file_safe "$MODULE/03_sql_vs_nosql_architecture/query_differences.md" <<'EOF'
# Query Differences
...
write_file_safe "$MODULE/03_sql_vs_nosql_architecture/tradeoffs.md" <<'EOF'
# Trade-Offs
...
write_file_safe "$MODULE/03_sql_vs_nosql_architecture/practice_comparisons.md" <<'EOF'
...
write_file_safe "$MODULE/04_document_database_modeling/README.md" <<'EOF'
...
write_file_safe "$MODULE/04_document_database_modeling/embedding_vs_referencing.md" <<'EOF'
...
write_file_safe "$MODULE/04_document_database_modeling/access_patterns.md" <<'EOF'
# Access Patterns
...
write_file_safe "$MODULE/04_document_database_modeling/denormalization.md" <<'EOF'
# Denormalization
...
write_file_safe "$MODULE/04_document_database_modeling/schema_design.md" <<'EOF'
# Schema Design
...
write_file_safe "$MODULE/04_document_database_modeling/anti_patterns.md" <<'EOF'
# Anti-Patterns
...
write_file_safe "$MODULE/04_document_database_modeling/modeling_exercises.md" <<'EOF'
# Modeling Exercises
...
write_file_safe "$MODULE/05_mongodb/README.md" <<'EOF'
# 05 MongoDB
...
write_file_safe "$MODULE/05_mongodb/python_setup.md" <<'EOF'
# Python Setup
...
write_file_safe "$MODULE/05_mongodb/queries.md" <<'EOF'
# MongoDB Queries
...
write_file_safe "$MODULE/05_mongodb/aggregation.md" <<'EOF'
# MongoDB Aggregation
...
write_file_safe "$MODULE/05_mongodb/indexing.md" <<'EOF'
# MongoDB Indexing
...
write_file_safe "$MODULE/05_mongodb/data_modeling.md" <<'EOF'
...
write_file_safe "$MODULE/05_mongodb/mongodb_vs_sql.md" <<'EOF'
# MongoDB vs SQL
...
write_file_safe "$MODULE/06_dynamodb/README.md" <<'EOF'
# 06 DynamoDB
...
write_file_safe "$MODULE/06_dynamodb/architecture.md" <<'EOF'
...
write_file_safe "$MODULE/06_dynamodb/partition_keys.md" <<'EOF'
# Partition Keys
...
write_file_safe "$MODULE/06_dynamodb/secondary_indexes.md" <<'EOF'
# Secondary Indexes
...
write_file_safe "$MODULE/06_dynamodb/query_patterns.md" <<'EOF'
...
write_file_safe "$MODULE/06_dynamodb/data_modeling.md" <<'EOF'
...
write_file_safe "$MODULE/06_dynamodb/scaling_and_throttling.md" <<'EOF'
...
write_file_safe "$MODULE/06_dynamodb/hot_partition_problem.md" <<'EOF'
# Hot Partition Problem
...
write_file_safe "$MODULE/06_dynamodb/dynamodb_vs_mongodb.md" <<'EOF'
# DynamoDB vs MongoDB
...
write_file_safe "$MODULE/06_dynamodb/practice_patterns.md" <<'EOF'
# Practice Patterns
...
write_file_safe "$MODULE/07_azure_databases_for_databricks/README.md" <<'EOF'
...
write_file_safe "$MODULE/07_azure_databases_for_databricks/azure_sql_database.md" <<'EOF'
# Azure SQL Database
...
write_file_safe "$MODULE/07_azure_databases_for_databricks/azure_sql_indexes.md" <<'EOF'
# Azure SQL Indexes
...
write_file_safe "$MODULE/07_azure_databases_for_databricks/azure_sql_stored_procedures.md" <<'EOF'
...
write_file_safe "$MODULE/07_azure_databases_for_databricks/azure_cosmosdb.md" <<'EOF'
# Azure CosmosDB
...
write_file_safe "$MODULE/07_azure_databases_for_databricks/cosmos_queries.md" <<'EOF'
# CosmosDB Queries
...
write_file_safe "$MODULE/07_azure_databases_for_databricks/cosmos_partitioning.md" <<'EOF'
...
write_file_safe "$MODULE/07_azure_databases_for_databricks/synapse_sql.md" <<'EOF'
# Synapse SQL
...
write_file_safe "$MODULE/07_azure_databases_for_databricks/synapse_queries.md" <<'EOF'
# Synapse Queries
...
write_file_safe "$MODULE/07_azure_databases_for_databricks/databricks_integration.md" <<'EOF'
# Databricks Integration
...
write_file_safe "$MODULE/07_azure_databases_for_databricks/database_selection_guide.md" <<'EOF'
...
write_file_safe "$MODULE/07_azure_databases_for_databricks/practical_usage_patterns.md" <<'EOF'
...
write_file_safe "$MODULE/07_azure_databases_for_databricks/synapse_vs_databricks_sql.md" <<'EOF'
...
echo "Learning materials completed."
...
echo "Filling SQL pet projects..."

write_file_safe "$MODULE/01_sql_analytics_engine/README.md" <<'EOF'
...
write_file_safe "$MODULE/01_sql_analytics_engine/dataset.md" <<'EOF'
# Dataset
...
write_file_safe "$MODULE/01_sql_analytics_engine/requirements.md" <<'EOF'
# Requirements
...
write_file_safe "$MODULE/01_sql_analytics_engine/architecture.md" <<'EOF'
# Architecture
...
write_file_safe "$MODULE/02_mongodb_event_store/README.md" <<'EOF'
...
write_file_safe "$MODULE/02_mongodb_event_store/architecture.md" <<'EOF'
# Architecture
...
write_file_safe "$MODULE/02_mongodb_event_store/document_model.md" <<'EOF'
# Document Model
...
write_file_safe "$MODULE/02_mongodb_event_store/query_patterns.md" <<'EOF'
# Query Patterns
...
write_file_safe "$MODULE/03_relational_to_document_migration/README.md" <<'EOF'
...
write_file_safe "$MODULE/03_relational_to_document_migration/source_model.md" <<'EOF'
# Source Model
...
write_file_safe "$MODULE/03_relational_to_document_migration/target_model.md" <<'EOF'
# Target Model
...
write_file_safe "$MODULE/03_relational_to_document_migration/migration_strategy.md" <<'EOF'
# Migration Strategy

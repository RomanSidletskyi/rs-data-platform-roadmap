...
cat <<'EOF' > "$MODULE/simple-tasks/01_analytics_queries/README.md"
...
cat <<'EOF' > "$MODULE/simple-tasks/02_window_queries/README.md" <<'EOF'
# 02 Window Queries
...
cat <<'EOF' > "$MODULE/simple-tasks/04_nosql_modeling/README.md" <<'EOF'
# 04 NoSQL Modeling
